...
#define STRING_CONFIG_H_AUTHOR "(Chronyko, Ender 5 Plus)" // Who made the changes.
...
// Increased max temp for Micro Swiss Hot-end
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.34, 79.34, 800, 96.96 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -7, -2.05 }
